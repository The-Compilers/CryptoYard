        ...
        <>
            <body>
                    ...
                    <form class="sign-up-form box" action="">
                            ...
                            <input class="sign-up-card__input" type="text" placeholder="Username"/>
                            <input class="sign-up-card__input" type="text" placeholder="Email" />
                            <input class="sign-up-card__input" type="text" placeholder="Password"/>
                            <input class="sign-up-card__input" type="text" placeholder="Repeat Password"/>
