        ...
        <>
            <body>
                    ...
                    <form className="sign-up-form box" action="">
                            ...
                            <input className="sign-up-card__input" type="text" placeholder="Username"/>
                            <input className="sign-up-card__input" type="text" placeholder="Email" />
                            <input className="sign-up-card__input" type="text" placeholder="Password"/>
                            <input className="sign-up-card__input" type="text" placeholder="Repeat Password"/>
