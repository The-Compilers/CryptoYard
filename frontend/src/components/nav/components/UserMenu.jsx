    ...
    <div className="user" ref={menuRef}>
      ...
      <ul className="user__dropdown">
        <li className="user__name noselect">
          <p className="user__name__text" onClick={toggleMenu}>
            {user.username}
          ...
          <ul
            className={
              expanded
                ? "user__dropdown__list box"
                : "user__dropdown__list user__dropdown__list--hidden box"
            }
            data-dropdown-list
          >
            ...
            <li className="user__dropdown__list__item">
              <a
                href="/signin"
                className="user__dropdown__list__link"
                onClick={onLogOut}
              >
                Log out
              </a>
